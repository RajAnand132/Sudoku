...
public class Sudoku {
    ...
    public static String getDialougeBox()
    {
        JFrame jFrame = new JFrame();
        String getName = JOptionPane.showInputDialog(jFrame, "Enter your name : ");
        ...
        JOptionPane.showMessageDialog(jFrame, "Your password for getting answers will be : "+getName);
        return getName;
    }

    public static void main(String[] args) {
        Panel pc=new Panel();
        pc.yourName=getDialougeBox();
        grid = new int[9][9];
        temp = new int[9][9];
        frame = new JFrame();
        ...
        frame.setTitle("</Suduko Game / Raj Anand> Enter only single digit number.");
    ...
    public static void newGame() {
        ...
        if (search(grid)) {
            System.out.println("OK...Game is starting!!!!!!!!!!!");
        }
